        ...
        <div class="row align-items-center bg-white py-3 px-lg-5">
            <div class="col-lg-4">
                <a href="index.html" class="navbar-brand p-0 d-none d-lg-block">
                    <h1 class="m-0 display-4 text-uppercase text-primary">SL<span class="text-secondary font-weight-normal">News</span></h1>
                </a>
            </div>
                ...
                <div class="navbar-nav mr-auto py-0">
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu rounded-0 m-0">
                            ...
                            <a href="#" class="dropdown-item">Helth</a>
                        </div>
                    </div>
...
$dbname = "news";   // Your database name
...
$result = mysqli_query($conn,$sql);
                ...
                <img class="img-fluid custom-size" src="/news/slnews/admin/uploads/<?php echo $row['image']; ?>" >
                        <div class="overlay">
                            <div class="mb-2">
                                <a class="badge badge-primary text-uppercase font-weight-semi-bold p-2 mr-2"
                                    href=""> <?php echo $row['news_category']?></a>
                                <a class="text-white" href="">Jan 33, 2045</a>
                            </div>
                            <a class="h2 m-0 text-white text-uppercase font-weight-bold" href="">
                            <?php echo $row['news_name']?></a>
                        </div>
                    </div>
                <?php
 }
...
$result = mysqli_query($conn,$sql);
                    ...
                    <div class="col-md-6 px-0">
                        ...
                        <img class="img-fluid custom-size" 
                        src="/news/slnews/admin/uploads/<?php echo $row['image']; ?>" 
     style="object-fit: cover; "> <div class="overlay">
                                <div class="mb-2">
                                    <a class="badge badge-primary text-uppercase font-weight-semi-bold p-2 mr-2"
                                        href=""><?php echo $row['news_category']?></a>
                                    <a class="text-white" href=""><small><?php echo $row['date']?></small></a>
                                </div>
                                <a class="h6 m-0 text-white text-uppercase font-weight-semi-bold" href=""><?php echo $row['news_name']?></a>
                            </div>
                        </div>
                    </div>
                    <?php
...
<div class="bg-white border border-top-0 p-4">
                                    ...
                                    <a class="h4 d-block mb-3 text-secondary text-uppercase font-weight-bold" href=""> <?php echo $row['news_name']?></a>
                                    <p class="m-0"> <?php echo $row['news_description']?></p>
                                </div>
...
<?php
 ...
 ?>
    ...
    <div class="container-fluid bg-dark pt-5 px-sm-3 px-md-5 mt-5">
        <div class="row py-4">
            <div class="col-lg-3 col-md-6 mb-5">
                ...
                <p class="font-weight-medium"><i class="fa fa-phone-alt mr-2"></i>+94 345 67890</p>
                <p class="font-weight-medium"><i class="fa fa-envelope mr-2"></i>SLNews@example.com</p>
    ...
    <div class="container-fluid py-4 px-sm-3 px-md-5" style="background: #111111;">
        <p class="m-0 text-center">&copy; <a href="#">SL NEWS</a>. All Rights Reserved. 
		
		<!--/*** This template is free as long as you keep the footer author’s credit link/attribution link/backlink. If you'd like to use the template without the footer author’s credit link/attribution link/backlink, you can purchase the Credit Removal License from "https://htmlcodex.com/credit-removal". Thank you for your support. ***/-->
		Design by <a href="https://htmlcodex.com">Kavindu</a></p>
    </div>
    <!-- Footer End -->
